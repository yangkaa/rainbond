...
type ApplicationHandler interface {
	...
	SyncComponent(app *dbmodel.Application, components []*model.Component) error
...
// SyncComponent -
func (a *ApplicationAction) SyncComponent(app *dbmodel.Application, components []*model.Component) error {
